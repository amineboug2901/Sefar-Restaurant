...
const createDatabase = async (connectionPromise) => {
    ...
    await connection.exec(
		...
		INSERT INTO produit(id_produit,nom,chemin_image,prix) VALUES(1,'baklava','./image/baklava.png',7.55);
		INSERT INTO produit(id_produit,nom,chemin_image,prix) VALUES(2,'Chakchouka','./image/chakchouka.jpeg',10.45);
		INSERT INTO produit(id_produit,nom,chemin_image,prix) VALUES(3,'harira','./image/harira.jpeg',1.5);
		INSERT INTO produit(id_produit,nom,chemin_image,prix) VALUES(4,'makroud','./image/makroud.jpg',3);
		INSERT INTO produit(id_produit,nom,chemin_image,prix) VALUES(5,'Couscous','./image/plate_1.jpg',3);
		INSERT INTO produit(id_produit,nom,chemin_image,prix) VALUES(6,'tajine','./image/tajine.jpg',3);
